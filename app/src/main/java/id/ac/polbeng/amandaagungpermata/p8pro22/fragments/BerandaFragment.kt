...
import id.ac.polbeng.amandaagungpermata.p8pro22.activities.DetailJasa
import id.ac.polbeng.amandaagungpermata.p8pro22.adapters.JasaAdapter
...
import id.ac.polbeng.amandaagungpermata.p8pro22.services.JasaService
                ...
                if(!response.body()?.error!!) {
                    ...
                    jasaResponse?.let {
                        ...
                        val jasaAdapter = JasaAdapter(daftarJasa) {
                                service -> Toast.makeText(context, "service clicked ${service.namaJasa}", Toast.LENGTH_SHORT).show()
                            val intent = Intent(context, DetailJasa::class.java)
